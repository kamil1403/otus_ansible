...
- [x] Nginx успешно работает на порту 8080 и отдает кастомную страницу. Результат см. на скриншоте 🖼️ ["evidence.png"](https://github.com/kamil1403/otus_ansible/blob/main/screenshots/otus_ansible_1.png)
