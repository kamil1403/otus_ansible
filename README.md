...
- [x] Nginx успешно работает на порту 8080 и отдает кастомную страницу. Результат см. на скриншоте 🖼️ ["Проверка работы.png"](https://github.com/kamil1403/otus_ansible/blob/main/screenshots/otus_ansible_1.png) и 🖼️ ["Nginx 8080.png"](https://github.com/kamil1403/otus_ansible/blob/main/screenshots/otus_ansible_2.png)
